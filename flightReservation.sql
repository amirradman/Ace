...
/*
insert into user(uName,age) values('Amir',48);
...
insert into user(uName,age) values('Negar',60);
...
insert into reservation values (100,201,current_date(),"2017-11-13 18:19:03");
...
insert into reservation values (102,202,current_date(),"2017-9-16 18:19:03");
insert into reservation values (101,202,current_date(),"2017-9-17 18:19:03");
insert into reservation values (101,203,current_date(),"2017-9-17 18:19:03");
insert into reservation values (103,200,current_date(),"2017-9-17 18:19:03");
insert into reservation values (103,201,current_date(),"2017-9-17 18:19:03");
insert into reservation values (104,201,current_date(),"2017-9-17 18:19:03");


insert into reservation(uid,fid,reservedDate) values(100,200,"2017-11-1");
insert into reservation(uid,fid,reservedDate) values(100,200,"2017-11-2");
insert into reservation(uid,fid,reservedDate) values(100,200,"2017-11-3");
insert into reservation(uid,fid,reservedDate) values(100,200,"2017-9-1");
insert into reservation(uid,fid,reservedDate) values(100,200,"2017-9-2");
insert into reservation(uid,fid,reservedDate) values(100,200,"2017-9-3");
insert into reservation(uid,fid,reservedDate) values(100,200,"2017-2-1");
insert into reservation(uid,fid,reservedDate) values(100,200,"2017-2-2");
insert into reservation(uid,fid,reservedDate) values(100,200,"2017-2-3");
insert into reservation(uid,fid,reservedDate) values(100,200,"2017-5-1");
insert into reservation(uid,fid,reservedDate) values(100,200,"2017-5-2");
insert into reservation(uid,fid,reservedDate) values(100,200,"2017-5-3");
insert into reservation(uid,fid,reservedDate) values(100,200,"2017-5-4");

select distinct MonthName(reservedDate) as 'High Season Month(s)' from reservation group by Month(reservedDate) having(count(*)>=4);
...
select * from user JOIN reservation using(uID) group by uid having(age > 20);
select FL.fid,aName,numSeats,uid,reservedDate,updatedAt from flightList FL left Outer JOIN reservation R on FL.fid = R.fid;

select avg(age) from user R1 Natural join (select distinct uid from reservation group by uid) T;
select distinct uid from reservation group by uid;
*/